...
![Eighty — A good hand. A better partnership.](docs/media/menu-en.png)
...
**Eighty is a free, open-source browser game of 80-fen**, also known as **Shengji / Tractor**. It brings a defined Shanghai ruleset to a table of pixel characters, paper cards, and green felt. Your partner sits opposite you. Your cards stay close at hand.
...
![Actual gameplay: smooth hover, selection, a single-card drag, and trick collection](docs/media/gameplay-en.gif)

*Recorded from the actual game: hover to read, click to select, drag one card, follow around the table, then flip and collect the trick.*
...
Created by [Tony Yun Yang](https://github.com/tonyyunyang) and contributors. Thanks to **ChannonTian** for the rules and practice-policy foundation in [80fen](https://github.com/ChannonTian/80fen), and to **GPT-6 Astra** for development assistance. Court, joker and card-back illustrations were AI-generated; title lettering, suit glyphs, portraits and interface design are project artwork.
