...
| [玩家指南](guide.md) | [Player guide](guide.en.md) |
| [规则细则](rules.zh-CN.md) | [Implemented rules](rules.md) |
| [贡献指南](../CONTRIBUTING.md) | [Contributing](../CONTRIBUTING.en.md) |

## 项目资料 / Project reference

- [FAQ](faq.md): free play, browsers, saves, online rooms and API costs.
- [Architecture](architecture.md): engine, controllers, providers and renderer boundaries.
...
[Report a bug](https://github.com/tonyyunyang/80-fen-shengji/issues/new/choose) · [Open a PR](https://github.com/tonyyunyang/80-fen-shengji/compare) · [Security reports](../SECURITY.md)
