...
test('v8 requests ignore actual hidden hands, the unknown kitty, shuffle seeds and private quizzes',()=>{
  ...
  for(const contextProfile of ['expert-audit-zh','expert-audit-en','expert-audit-search-zh','expert-audit-search-en','expert-cooperate-zh','expert-cooperate-en','expert-cooperate-search-zh','expert-cooperate-search-en','expert-zh','expert-en','expert-facts-zh','expert-facts-en','expert-search-zh','expert-search-en','expert-search-wide-zh','search','partnership-plan','partnership-plan-search'])assert.deepEqual(buildRequest(changed,seat,{...options,contextProfile}),buildRequest(view,seat,{...options,contextProfile}));
