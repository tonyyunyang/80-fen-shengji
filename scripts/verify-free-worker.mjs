...
try{
  ...
  assert.ok(cooperation.requests.every(r=>r.outcome==='valid'&&r.contextVersion===21&&r.analysisStatus===null),'hosted card play uses partnership reading without Node analysis');
