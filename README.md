...
![八十分 · Eighty — 一副好牌，一位好搭档](docs/media/menu-zh.png)
...
**Eighty 是免费开源的八十分网页游戏**，也叫升级、拖拉机。它采用一套明确的上海规则，把熟悉的搭档牌戏放进像素人物、纸质牌面和绿色绒面的牌桌里。对家就在对面，手牌就在手边。

**本地游玩无需账号、API key 或订阅。** 自带三个免费的本地陪练，打开就能练一局。也可以让自己的 AI 模型入座；这是可选功能，费用由你选择的服务商决定。

## 看它动起来

![真实游戏录像：悬停看牌、点选、单张拖出与收墩动画](docs/media/gameplay-zh.gif)

*录制自实际游戏界面：悬停展开，点选悬起，单张拖出，四家跟牌，翻牌收墩。*
...
| **手牌有手感** | 25 张与拿底后的 33 张都保持一排。悬停平滑展开，单击选中；合法单牌拖出即可打出，多张选好后一起出。 |
...
默认是你和三个本地陪练。画面偏好在主菜单的「设置」里；座位和本桌规则在「新游戏」里。菜单支持中文与 English。
...
由 [Tony Yun Yang](https://github.com/tonyyunyang) 与贡献者制作。感谢 **ChannonTian** 的 [80fen](https://github.com/ChannonTian/80fen) 提供规则与陪练基础，感谢 **GPT-6 Astra** 协助开发。人头牌、大小王与牌背使用 AI 生成；标题字形、花色、人物和界面是项目中的原创设计。
